...
This folder sits outside the `pabutools/` package: it holds benchmark scripts
and their output, not library code.
...
On branch `perf-improvement`.

## What was changed

The hyperparameter search in
[`train_classification`](../pabutools/recommendation/model_training.py) fitted a
